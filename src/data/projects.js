...
// Central list of projects, shared by the Home showcase and the Projects page.
// `internal: true` links stay inside the site (React Router); others open in a new tab.
